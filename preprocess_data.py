...
# def preprocess_mnist_digits(digit1, digit2, n_samples, n_components):
#     print("Loading MNIST...")
...
#     # resampling
#     X_resampled, y_resampled = resample(X_filtered, y_binary, n_samples=n_samples, random_state=42, stratify=y_binary)

#     # PCA applied
#     X_reduced = preprocess(X_resampled, 'pca', n_components=n_components)
